...
actionLink: /workshop/
description: A workshop using the Particle Argon.
features:
...
- title: "Work with mesh"
  details: Using the mesh capabilities of the Argon, connect two devices to the same mesh network, and send messages between them instantly.
- title: "Build a demo"
